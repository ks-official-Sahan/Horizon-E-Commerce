...
class PHPMailer
{
    ...
    public static function setupMail($emailAddress,$emailSubject,$bodyContent) {
        ...
        if (!isset($mail)) {
            ...
            $mailSetup->Port = 465;
            $mailSetup->setFrom('horizon.csr.official@gmail.com', 'Verification');
            $mailSetup->addReplyTo('horizon.csr.official@gmail.com', 'Verification');
            ...
            if (!$mailSetup->send()) {
                $response = 'Verification code sending failed';
                return $response;
            } else {
                $response = 'success';
                return $response;
