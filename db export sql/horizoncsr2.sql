...
CREATE DATABASE IF NOT EXISTS `horizoncsr` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `horizoncsr`;
...
CREATE TABLE IF NOT EXISTS `brand` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK_brand_sub_category` (`sub_category_id`),
  CONSTRAINT `FK_brand_sub_category` FOREIGN KEY (`sub_category_id`) REFERENCES `sub_category` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE IF NOT EXISTS `brand_has_model` (
  ...
  CONSTRAINT `FK_brand_has_model_brand` FOREIGN KEY (`brand_id`) REFERENCES `brand` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_brand_has_model_model` FOREIGN KEY (`model_id`) REFERENCES `model` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE IF NOT EXISTS `cart` (
  ...
  CONSTRAINT `FK__product3` FOREIGN KEY (`product_id`) REFERENCES `product` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK__user3` FOREIGN KEY (`user_email`) REFERENCES `user` (`email`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE IF NOT EXISTS `chat` (
  ...
  KEY `FK__user_5` (`from`),
  KEY `FK__user_5.5` (`to`),
  CONSTRAINT `FK__user_5` FOREIGN KEY (`from`) REFERENCES `user` (`email`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK__user_5.5` FOREIGN KEY (`to`) REFERENCES `user` (`email`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE IF NOT EXISTS `city` (
  ...
  CONSTRAINT `FK_city_district` FOREIGN KEY (`district_id`) REFERENCES `district` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE IF NOT EXISTS `feedback` (
  ...
  `user_email` varchar(100) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `FK_feedback_product6` (`product_id`) USING BTREE,
  KEY `FK_feedback_user7` (`user_email`) USING BTREE,
  CONSTRAINT `FK_feedback_product6` FOREIGN KEY (`product_id`) REFERENCES `product` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_feedback_user7` FOREIGN KEY (`user_email`) REFERENCES `user` (`email`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `images` (
  ...
  `product_id1` int(10) NOT NULL,
  PRIMARY KEY (`code`),
  KEY `fk_images_product1_idx` (`product_id1`),
  CONSTRAINT `fk_images_product1` FOREIGN KEY (`product_id1`) REFERENCES `product` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `invoice` (
  ...
  `product_id` int(10) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `FK_invoice_product5` (`product_id`) USING BTREE,
  KEY `FK_invoice_user6` (`user_email`) USING BTREE,
  CONSTRAINT `FK_invoice_product5` FOREIGN KEY (`product_id`) REFERENCES `product` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_invoice_user6` FOREIGN KEY (`user_email`) REFERENCES `user` (`email`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE IF NOT EXISTS `product` (
  ...
  `brand_has_model_id` int(10) NOT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `fk_product_sub_category_2` (`sub_category_id`) USING BTREE,
  KEY `fk_product_category_1_idx` (`category_id`) USING BTREE,
  KEY `fk_product_brand_has_model_1_idx` (`brand_has_model_id`) USING BTREE,
  KEY `fk_product_colour_1_idx` (`colour_id`) USING BTREE,
  KEY `fk_product_condition_1_idx` (`condition_id`) USING BTREE,
  KEY `fk_product_status_1_idx` (`status_id`) USING BTREE,
  KEY `fk_product_user_1_idx` (`user_email`) USING BTREE,
  CONSTRAINT `FK_product_brand_has_model` FOREIGN KEY (`brand_has_model_id`) REFERENCES `brand_has_model` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_product_category` FOREIGN KEY (`category_id`) REFERENCES `category` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_product_colour` FOREIGN KEY (`colour_id`) REFERENCES `colour` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_product_condition` FOREIGN KEY (`condition_id`) REFERENCES `condition` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_product_status` FOREIGN KEY (`status_id`) REFERENCES `status` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_product_sub_category_2` FOREIGN KEY (`sub_category_id`) REFERENCES `sub_category` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_product_user` FOREIGN KEY (`user_email`) REFERENCES `user` (`email`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8;

-- Dumping data for table horizoncsr.product: ~0 rows (approximately)

-- Dumping structure for table horizoncsr.profile_image
CREATE TABLE IF NOT EXISTS `profile_image` (
  ...
  CONSTRAINT `fk_profile_image_user1` FOREIGN KEY (`user_email`) REFERENCES `user` (`email`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8;

-- Dumping data for table horizoncsr.profile_image: ~0 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `recent` (
  ...
  `user_email` varchar(100) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `FK_recent_product 2` (`product_id`) USING BTREE,
  KEY `FK_recent_user_2` (`user_email`) USING BTREE,
  CONSTRAINT `FK_recent_product_2` FOREIGN KEY (`product_id`) REFERENCES `product` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_recent_user_2` FOREIGN KEY (`user_email`) REFERENCES `user` (`email`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE IF NOT EXISTS `sub_category` (
  ...
  `category_id` int(10) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `FK_sub_cat_category` (`category_id`) USING BTREE,
  CONSTRAINT `FK_sub_cat_category` FOREIGN KEY (`category_id`) REFERENCES `category` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE IF NOT EXISTS `support` (
  ...
  `to` varchar(100) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_support_admin_1_idx` (`to`) USING BTREE,
  CONSTRAINT `fk_support_admin_1` FOREIGN KEY (`to`) REFERENCES `admin` (`email`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE IF NOT EXISTS `user_has_address` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_user_has_city_city_1_idx` (`city_id`) USING BTREE,
  KEY `fk_user_has_city_user_1_idx` (`user_email`) USING BTREE,
  CONSTRAINT `fk_user_has_city_city_1` FOREIGN KEY (`city_id`) REFERENCES `city` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_user_has_city_user_1` FOREIGN KEY (`user_email`) REFERENCES `user` (`email`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `watchlist` (
  ...
  `user_email` varchar(100) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `FK_watchlist_product_10` (`product_id`) USING BTREE,
  KEY `FK_watchlist_user_10` (`user_email`) USING BTREE,
  CONSTRAINT `FK_wishlist_product_10` FOREIGN KEY (`product_id`) REFERENCES `product` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_wishlist_user_10` FOREIGN KEY (`user_email`) REFERENCES `user` (`email`) ON DELETE NO ACTION ON UPDATE NO ACTION
