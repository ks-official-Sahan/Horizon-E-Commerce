...
<body class="homex bg-light" onload="intro();">
    ...
    if (isset($_SESSION["user"])) {
        ...
        ?>
            ...
            <div class="container-fluid vh-100 d-flex justify-content-center containBox" style="<?php echo ($result); ?>"
                id="containBox">
                    ...
                    <div class="col-12 p-3 mb-5" id="navigator">
                        ...
                        <div class="row g-2 justify-content-center mt-3">
                            <div class="col-lg-5 col-11 d-grid">
                                <span class="btn btn-primary rounded-5 text-white fw-bold" style="letter-spacing: 0.2rem;"
                                    onclick="showSignUp();">Sign Up</span>
                            </div>
                            <div class="col-lg-5 offset-lg-1 col-11 d-grid">
                                <span class="btn btn-primary rounded-5 text-white fw-bold" style="letter-spacing: 0.2rem;"
                                    onclick="showSignIn();">Sign In</span>
                            </div>
                            <div class="col-lg-7 col-11 d-grid mt-4 mb-5">
                                <span class="btn btn-secondary rounded-5" onclick="visitAsGuest();"
                                    style="letter-spacing: 0.2rem;">Visit as a <i
                                        class="text-uppercase text-warning fw-bold">Guest</i></span>
                            </div>
                            <div class="col-lg-7 col-11 d-grid mt-5 rounded rounded-5 px-5">
                                <span
                                    class="btn btn-outline-danger fs-5 fw-bold border-0 text-uppercase rounded rounded-5 adminSignInBtn"
                                    onclick="showAdminSignIn();">Admin Sign In</span>
                            </div>
                        </div>
                    </div>
                    <!-- Navigator -->
                        ...
                        <div class="row g2">
                            ...
                            <div class="col-lg-7 col-12 d-none pb-5 text-white pe-5" id="signUp">
                                <div class="row g-1 mb-3">
                                    ...
                                    <div class="col-12 mb-2">
                                        <h1 class="fw-bold text-danger text-lg-start text-center"><button class="btn btn-danger"
                                                onclick="signUp2Welcome();">&larr;</button>&nbsp; Sign Up Portal</h1>
                                    </div>

                                    <!-- alert box -->
                                    <div class="col-12 px-2 py-2 d-none rounded rounded-4" id="alertDiv1"
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <button class="btn btn-primary" type="button" onclick="showPasswordUp();"
                                                id="show"><i class="bi bi-eye-slash-fill"></i></button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6 col-12">
                                        ...
                                        <div class="input-group">
                                            <div class="col-4">
                                                <select class="form-select bg-primary text-start w-100 overflow-scroll"
                                                    id="country">
                                    ...
                                    <div class="col-12 mt-4 mb-3">
                                        <div class="row g-2">
                                            ...
                                            <div class="col-12 col-lg-6 d-grid">
                                                <button class="btn btn-dark" onclick="changeView();">Have an Account? Sign
                                                    In</button>
                                            </div>
                            ...
                            <div class="col-lg-6 col-12 d-none text-white" id="signIn">
                                <div class="row g-2">
                                    ...
                                    <div class="col-12 mb-2">
                                        <h1 class="fw-bold text-danger text-lg-start text-center"><button class="btn btn-danger"
                                                onclick="signIn2Welcome();">&larr;</button>&nbsp; Sign In Portal</h1>
                                    </div>

                                    <!-- alert box -->
                                    <div class="col-12 px-2 py-2 d-none rounded rounded-4" id="alertDiv2"
                                        style="margin-top: -10px;">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <button class="btn btn-primary" type="button" onclick="showPasswordIn();"
                                                id="showIn"><i class="bi bi-eye-slash-fill"></i></button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-6">
                                        <a href="#" class="link-danger text-decoration-none text-end fw-bold"
                                            onclick="forgotUserPassword();">Forgot Password?</a>
                                    </div>
                            ...
                            <div class="col-lg-6 col-12 d-none" id="adminSignIn">
                                <div class="row g-2 justify-content-center">
                                    ...
                                    <!-- alert box -->
                                    <div class="col-12 px-2 py-2 d-none rounded rounded-4" id="alertDiv3"
                                        style="margin-top: -10px;">
                                    ...
                                    <div class="col-12 mb-3" id="vcodeDiv">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <button class="btn btn-primary w-25" type="button" id="sendbtn"
                                                onclick="sendVerificationAdmin();"><i class="bi bi-send-fill"></i> Send</button>
                                        </div>
                                    </div>
                                    <!-- <div class="col-12">
                                    <label class="form-label">Password</label>
                                    ...
                                    <div class="col-12 col-lg-6 d-grid my-2">
                                        <button class="btn btn-dark" onclick="back2WelcomeAdmin();">Back to Welcome
                                            Page</button>
                                    </div>
                    ...
                    <div class="modal" tabindex="-1" id="forgotPasswordUserModal">
                        <div class="modal-dialog modal-fullscreen">
                            <div class="modal-content"
                                style="background-image: linear-gradient(90deg, hsl(151, 70%, 56%) 0%, hsl(223, 67%, 44%) 50%, hsl(253, 46%, 32%) 100%);">
                                    ...
                                    <div class="row g-3 text-white justify-content-center pt-3 pe-4 ps-3">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <button class="btn btn-danger" type="button" id="unpb"
                                                    onclick="showPasswordUN();"><i class="bi bi-eye-slash-fill"></i></button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="input-group mb-3">
                                                <input type="password" class="form-control" id="urnpi"
                                                    onkeyup="checkPasswordUser();" />
                                                <button class="btn btn-danger" type="button" id="urnpb"
                                                    onclick="showPasswordUR();"><i class="bi bi-eye-slash-fill"></i></button>
                                            </div>
                                        </div>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="button" class="btn btn-primary" onclick="resetUserPassword();">Reset User
                                        Password</button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class=" modal-dialog modal-fullscreen p-4 pe-5">
                            <div class="modal-content rounded rounded-4 shadow" style="<?php echo ($result); ?>">
                                <div class="modal-header text-center shadow">
                                    <h5 class="modal-title text-primary fw-bold text-uppercase fs-4"
                                        style="letter-spacing: 0.1rem;">Help & Support</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                    ...
                                    <div class="col-12">
                                        <div class="row justify-content-center align-items-center align-content-center">
                                            ...
                                            <div class="col-12 h-100 border-top">
                                                <div
                                                    class="row align-content-center align-items-center justify-content-center py-lg-3">
                    ...
                    <div class="col-12 fixed-bottom d-block text-warning text-center">
                        <div class="row">
                            <div class="col-12 d-none d-lg-block">
                                <span> &copy; 2022 Horizon CSR || All Rights Reserved || Developed by Sahan
                                    Sachintha&trade;</span>
                            </div>
                            <div class="col-12 mb-2">
                                <a href="#" class="text-decoration-none fw-bold text-white fs-5" onclick="support();">Help &
                                    Support</a>
                            </div>
                        </div>
                    </div>
