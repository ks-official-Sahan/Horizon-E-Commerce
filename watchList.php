                                                ...
                                                <nav aria-label="breadcrumb">
                                                    <div class="breadcrumb">
                                                        ...
                                                        <a href="#" aria-current="page"
                                                            class="breadcrumb-item fw-bold active">Watch List</a>
                                                    </div>
                                                </nav>
                                            </div>
                                            <div class="col-12">
                            ...
                            if ($watchlist_count > 0) {
                                ...
                                <div class="col-12 col-lg-9 px-lg-5 p-3" id="haveProduct">
                                    <div class="row justify-content-center p-2">
                                        ...
                                        <?php
                                        for ($count = 0; $count < $watchlist_count; $count++) {
                                                            ...
                                                            <div class="col-6">
                                                                <div class="card-body d-grid">
                                                                    ...
                                                                    <a href="#" class="btn btn-outline-danger mb-2"
                                                                        onclick="removeFromWatchList(<?php echo ($watchlist_data['watchlist_id']); ?>);">Remove</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
